      ...
      <div className="relative w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="border-white/10 hover:bg-white/5 hover:border-brand-primary/30 transition-colors" onClick={() => handleOAuth("google")}>
            ...
            <Button variant="outline" className="border-white/10 hover:bg-white/5 hover:border-brand-primary/30 transition-colors" onClick={() => handleOAuth("github")}>
          ...
          <div className="relative">
            ...
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-brand-surface-light px-3 text-xs text-gray-500">or sign up with email</span>
          </div>
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="name">Full Name</Label>
              <Input id="name" placeholder="Jane Smith" value={fullName} onChange={(e) => setFullName(e.target.value)} required className="bg-white/5 border-white/10" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" placeholder="Min. 6 characters" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} className="bg-white/5 border-white/10" />
            </div>
