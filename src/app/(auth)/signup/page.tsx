      ...
      <Card className="w-full max-w-md bg-[#111118] border-white/[0.06]">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <Button variant="outline" className="border-white/10 hover:bg-white/5" onClick={() => handleOAuth("google")}>
            ...
            <Button variant="outline" className="border-white/10 hover:bg-white/5" onClick={() => handleOAuth("github")}>
          ...
          <div className="relative">
            ...
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#111118] px-3 text-xs text-gray-500">or sign up with email</span>
          </div>
